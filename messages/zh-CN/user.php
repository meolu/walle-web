...
return [
    ...
    'is admin' => '是否管理员',
    'status' => '状态',
    'status to opposite 2' => '解冻',
    'status to opposite 10' => '冻结',
    'status to opposite 0' => '冻结',
    'role to opposite 1' => '设为开发者',
    'role to opposite 2' => '设为管理员',
    'rename' => '修改用户名',
    'label role to opposite 1' => '确定设置为普通用户？',
    'label role to opposite 2' => '确定设置为管理员？',
    'label status to opposite 0' => '确认帐号冻结冻结？',
    'label status to opposite 2' => '确认帐号解除冻结？',
    'label status to opposite 10' => '确认帐号冻结冻结？',
